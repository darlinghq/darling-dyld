...
// dyld_fall_2019_os_versions => bridgeos 4.0 / ios 13.0 / macos 10.15 / tvos 13.0 / watchos 6.0
#define dyld_fall_2019_os_versions                      ({ (dyld_build_version_t){0xffffffff, 0x007e30901}; })

// dyld_autumn_2019_os_versions => bridgeos 4.0 / ios 13.1 / macos 10.15 / tvos 13.0 / watchos 6.0
#define dyld_autumn_2019_os_versions                    ({ (dyld_build_version_t){0xffffffff, 0x007e30902}; })

// dyld_late_fall_2019_os_versions => bridgeos 4.1 / ios 13.2 / macos 10.15.1 / tvos 13.2 / watchos 6.1
#define dyld_late_fall_2019_os_versions                 ({ (dyld_build_version_t){0xffffffff, 0x007e31015}; })

// dyld_winter_2019_os_versions => bridgeos 4.1 / ios 13.3 / macos 10.15.1 / tvos 13.3 / watchos 6.1
#define dyld_winter_2019_os_versions                    ({ (dyld_build_version_t){0xffffffff, 0x007e31201}; })

// dyld_spring_2020_os_versions => bridgeos 4.1 / ios 13.4 / macos 10.15.1 / tvos 13.4 / watchos 6.2
#define dyld_spring_2020_os_versions                    ({ (dyld_build_version_t){0xffffffff, 0x007e40301}; })

// dyld_late_spring_2020_os_versions => bridgeos 4.1 / ios 13.5 / macos 10.15.1 / tvos 13.4 / watchos 6.2
#define dyld_late_spring_2020_os_versions               ({ (dyld_build_version_t){0xffffffff, 0x007e40415}; })

// dyld_summer_2020_os_versions => bridgeos 4.1 / ios 13.6 / macos 10.15.1 / tvos 13.4 / watchos 6.2
#define dyld_summer_2020_os_versions                    ({ (dyld_build_version_t){0xffffffff, 0x007e40601}; })

// dyld_late_summer_2020_os_versions => bridgeos 4.1 / ios 13.7 / macos 10.15.1 / tvos 13.4 / watchos 6.2
#define dyld_late_summer_2020_os_versions               ({ (dyld_build_version_t){0xffffffff, 0x007e40715}; })

// dyld_fall_2020_os_versions => bridgeos 5.0 / ios 14.0 / macos 10.16 / tvos 14.0 / watchos 7.0
#define dyld_fall_2020_os_versions                      ({ (dyld_build_version_t){0xffffffff, 0x007e40901}; })

// dyld_late_fall_2020_os_versions => bridgeos 5.0 / ios 14.2 / macos 10.16 / tvos 14.2 / watchos 7.1
#define dyld_late_fall_2020_os_versions                 ({ (dyld_build_version_t){0xffffffff, 0x007e41015}; })

// dyld_winter_2020_os_versions => bridgeos 5.1 / ios 14.3 / macos 11.1 / tvos 14.3 / watchos 7.2
#define dyld_winter_2020_os_versions                    ({ (dyld_build_version_t){0xffffffff, 0x007e41201}; })

// dyld_spring_2021_os_versions => bridgeos 5.3 / ios 14.5 / macos 11.3 / tvos 14.5 / watchos 7.4
